...
class BatimentGui:
    ...
    def __init__(self, area, params):
        ...
        # Représentation graphique du bâtiment avec étages, boutons d'appel et cages d'ascenseur
    ...
    def on_draw(self, area, context):
        ...
        for idx_asc in range(self.params.nb_asc):
            ...
            context.rectangle(ORG_BAT_X + LRG_BAT_1 + ((idx_asc+1) * LRG_BAT_ASC),
                              HAUTEUR_SOL,
                              LRG_BAT_ASC,
